                ...
                <div className="flex flex-wrap py-4 pb-4 overflow-hidden sm:-mx-2 pl-16 md:-mx-2 lg:-mx-2 xl:-mx-2">
                    {data ? data.results.map(MovieCard => {
                        ...
                        return (
                            ...
                            <p key={MovieCard.id + 11} className="bg-zinc-800 max-w-[18rem] rounded-sm break-words text-gray-300 text-sm leading-0 font-semibold py-2 text-center">{MovieCard.title} <b>(Movie)</b></p>
                            </a>
                            </Link> : 
                            ...
                            <p key={MovieCard.id + 13} className="bg-zinc-800 max-w-[18rem] rounded-sm break-words text-gray-300 text-sm leading-0 font-semibold py-2 text-center">{MovieCard.name} <b>(TV)</b></p>
                            </a>
                            </Link>    
                            }
