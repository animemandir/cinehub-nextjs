                    ...
                    {data && data.map(MovieCard => {
                        return (
                            ...
                            <div className="rounded-md overflow-hidden">
                                ...
                                <a title={MovieCard.title} key={MovieCard.id}>
                                <img className="w-11/12 hover:opacity-70" key={MovieCard.id} title={MovieCard.title} src={`https://image.tmdb.org/t/p/w500${MovieCard.poster_path}`} alt={MovieCard.title} width="1500px" height="2250px"/>
                                </a>
                                </Link>
                            </div>
                            </div>
