...
const TvCards = (props) => {
    ...
    <div className="rounded-md overflow-hidden">
        ...
        <img className="w-11/12 hover:opacity-70" title={TvCard.title} src={`https://image.tmdb.org/t/p/w500${TvCard.poster_path}`} alt={TvCard.title} width="1500px" height="2250px"/>
        </a>
        </Link>
    </div>
    </div>           
